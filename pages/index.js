...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>The Best IPTV Subscription Service Provider - Infinity IPTV - </title>
      ...
      <section className={`container-fluid pt-5 pb-2 mb-3 ${styled.section1}`}>
              <h1 className="fs-1 fw-bolder text-black pt-5 mt-3 text-center mb-4">FAQ</h1>
              <div className="accordion accordion-flush" id="accordionFlushExample">

                <div className={`accordion-item ${styled.accordionBtn}`}>
