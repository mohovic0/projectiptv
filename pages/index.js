    ...
    <>  
      ...
      <section ref={ref} className={`${styles.section4}`}>
          ...
          <div className='container-fluid d-block  d-xs-block  d-md-block d-sm-block d-lg-flex justify-content-lg-evenly flex-lg-wrap'>
              ...
              <div className={` mb-5 ${styles.divcard}`}><Card  mois = '3' price='14.99' id='64e4013f2de52' /></div>
              <div className={` mb-5 ${styles.divcard}`}><Card  mois = '6' price='19.99' id='64e40104f2f95' /></div>
              <div className={` mb-5 ${styles.divcard}`}><Card  mois = '12' price='34.99' id='64e3e7d83a767'/></div>
