...
function Faq() {
  return (
    <>
      <Head>
        <title>IPTV Streaming - USA - FAQs</title>
        <meta name="description" content="Explore our IPTV streaming service in the USA and find answers to 
        commonly asked questions in our FAQ section. Learn more about 
        our offerings, features, and how to make the most of your viewing experience" />
        ...
        <meta property="og:title" content="IPTV Streaming - USA - FAQs"/>
        <meta property="og:description" content="Explore our IPTV streaming service in the USA and find answers to 
        commonly asked questions in our FAQ section. Learn more about our offerings, 
        features, and how to make the most of your viewing experience"/>
        ...
        <div>
          ...
          <section className={`container-fluid pt-5 pb-2 ${styles.section1}`}>
              <h1 className=" pt-5 mt-3 mb-4">FAQ</h1>
